...
import '../styles/pages/watchlist-page.css';
  ...
  return (
    ...
    >
      ...
      <div className="kpi-grid">
        <MetricBox label="Total Stocks" value={`${watchlist.length}`} subtitle="Current list size" />
        <MetricBox label="US Exposure" value={`${usCount}`} subtitle="US market symbols" />
        <MetricBox label="Indian Exposure" value={`${inCount}`} subtitle="IN market symbols" />
        <MetricBox
          label="Green Moves"
          value={`${positiveMoves}`}
          tone="positive"
